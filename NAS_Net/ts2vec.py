...
import numpy as np
from .ts2vec_model import TSEncoder
from .ts2vec_model.losses import hierarchical_contrastive_loss
    ...
    def fit(self, train_data, n_epochs=None, n_iters=None, verbose=False):
        ...
        while True:
            ...
            for batch in train_loader:
                ...
                x = batch[0]
                # 如果高于max_train_length，就随机从中切出长度为max_train_length的序列
                # -------|---
                # --|-------|-
